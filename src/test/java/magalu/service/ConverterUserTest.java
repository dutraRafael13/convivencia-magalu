...
public class ConverterUserTest {
    ...
    public void convertTest() {
        Map<Integer, User> users = new ConverterUser().convert("src/test/resources/data_teste.txt");
    ...
    public void getOrdersTestAddProduct() {
        ...
        orders = new ConverterUser().getOrders(orders, 1, 2, 2.0, "20220722");
    ...
    public void getOrdersTestAddOrder() {
        List<Order> orders = this.getOrders(1,1,1.0);
        orders = new ConverterUser().getOrders(orders, 2, 2, 2.0, "20220722");
    ...
    public void getUsersTestUpdateUser() {
        ...
        mapUsers = new ConverterUser().getUsers(mapUsers, new User(1, "Rafael", orders));
    ...
    public void getUsersTestNewUser() {
        ...
        mapUsers.put(1, new User(1, "Rafael", orders));
        orders.addAll(this.getOrders(2,2,2.0));
        mapUsers = new ConverterUser().getUsers(mapUsers, new User(2, "João", orders));
    ...
    public void verifyTotal() {
        ...
        mapUsers.put(1, new User(1, "Rafael", orders));
        mapUsers = new ConverterUser().verifyTotal(mapUsers);
    ...
    private List<Order> getOrders(Integer orderId, Integer productId, Double value) {
        ...
        orders.add(new Order(orderId, 0.0, "20220722", products));
        return orders;
    }
